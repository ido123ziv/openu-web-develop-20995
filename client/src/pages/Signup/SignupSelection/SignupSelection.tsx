      ...
      <Container className={styles.container}>
        <Segment className={styles.borderedSegment}>
          ...
          <p className={styles.explanationText}>
            Welcome to our babysitter network! Whether you&#39;re a parent
            looking for trustworthy babysitters or a babysitter seeking new
            opportunities, our platform is here to connect you. Please select
            your role below to get started with the relevant sign-up process.
          </p>
