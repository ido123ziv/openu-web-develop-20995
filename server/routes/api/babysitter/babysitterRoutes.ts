...
import { BABYSITTER_INVALID_INPUT_ERROR } from "../../../utils/global/globals";
...
babysitterRouter.get(
  ...
  async (req: Request, res: Response) => {
    try {
      const babysittersCount = await handler.countBabysitters();

      return res.status(200).json({ babysittersCount });
    } catch (e) {
      console.log(
