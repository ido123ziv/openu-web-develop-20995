...
var DBHandler = /** @class */ (function () {
    ...
    DBHandler.prototype.getBabysitter = function (babysitterId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, babysitter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "SELECT babysitter_id\n                  FROM babysitters \n                  WHERE babysitter_id = $1 AND\n                        end_timestamp = $2";
                        return [4 /*yield*/, db_1.default.query(query, [babysitterId, globals_1.END_TIMESTAMP])];
                    case 1:
                        babysitter = _a.sent();
                        return [2 /*return*/, babysitter.rows[0]];
                }
            });
        });
    };
    DBHandler.prototype.getNumWatchedProfile = function (babysitterId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, numWatched;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "SELECT COUNT(*) AS amount\n                    FROM parents_babysitters_interactions\n                    WHERE babysitter_id = $1";
                        return [4 /*yield*/, db_1.default.query(query, [babysitterId])];
                    case 1:
                        numWatched = _a.sent();
                        return [2 /*return*/, numWatched.rows[0].amount];
                }
            });
        });
    };
    DBHandler.prototype.getInteractionsData = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var query, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
